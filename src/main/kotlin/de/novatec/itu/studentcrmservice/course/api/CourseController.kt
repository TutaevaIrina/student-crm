...
class CourseController (
    ...
    fun createCourse(@RequestBody @Valid courseRequestDTO: CourseRequestDTO) =
    ...
    @ResponseStatus(HttpStatus.CREATED)
    fun updateCourse(@PathVariable courseId: Long, @RequestBody @Valid courseRequestDTO: CourseRequestDTO) =
        courseService.updateCourse(courseId, courseRequestDTO.courseName)
