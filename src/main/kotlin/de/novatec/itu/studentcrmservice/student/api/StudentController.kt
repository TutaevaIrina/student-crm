...
class StudentController (
    ...
    fun createStudent(@Valid @RequestBody studentRequestDTO: StudentRequestDTO) =
    ...
    @ResponseStatus(HttpStatus.CREATED)
    fun updateStudent(@PathVariable studentId: Long, @Valid @RequestBody studentRequestDTO: StudentRequestDTO) =
