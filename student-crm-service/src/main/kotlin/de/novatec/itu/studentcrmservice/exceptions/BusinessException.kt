...
class StudentNotEnrolledInCourseException(courseId: Long, studentId: Long) : BusinessException("Student with id $studentId does not enrolled in the course with id $courseId")
